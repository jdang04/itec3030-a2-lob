...
public class TradingAgentInstitutionalFactory extends AbstractTradingAgentFactory {
    ...
    public TradingAgent createAgent(String type, String style, Trader t, StockExchange e, NewsBoard n) {
        ...
        return new TradingAgentInstitutional(t, e, n, strategy); // Make sure to pass the strategy here
    }
}
